...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedUserType = localStorage.getItem("userType")?.toUpperCase() || "";
  ...
  // ✅ Define accessible actions per userType
  const getQuickActions = () => {
    ...
    return allActions.filter((action) => action.allowed.includes(userType));
  };
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      {/* Stats Cards - Only show to Admin */}
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {quickActions.length === 0 ? (
                <p className="text-muted-foreground col-span-full">No actions available for your role.</p>
              ) : (
      ...
      {(userType === "ADMINISTRATOR" || userType === "TEACHER") && (
